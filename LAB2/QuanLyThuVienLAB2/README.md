...
2. **Cấu hình kết nối (Connection String):** 
   ...
   - *Ví dụ:* `<add name="QuanLyThuVien"
              	 connectionString="Data Source=ANHOANG; Initial Catalog=QuanLyThuVien;User ID=sa; Password=1; Integrated Security=True; TrustServerCertificate=True; MultipleActiveResultSets=True"
